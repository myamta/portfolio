      ...
      <section className="projectInfo">
         <div className="projectWrapper">
            <div class="pjTitleBox">
               <h2>닥터모두</h2>
               <h3>2022.12.15 ~ 2022.12.27</h3>
            </div>
            <div className="pjImgBox">
               <img src={path + './images/photo4.png'} alt="" />
            </div>
            <div class="complete">
               <div class="overview">
                  <h3>OVERVIEW</h3>
                  <div className="overviewInner">
                     <h4>닥터모두는 헤어에 관련된 제품을 팔고 있는 헤어케어 브랜드의 웹사이트입니다.</h4>
                     <p>
                        해당 프로젝트는 실존하는 사이트를 팀원들과 협업하여 제한시간 내에 구현해내는 프로젝트였습니다.
                     </p>
               ...
               <div class="ps">
                  ...
                  <div className="task" data-aos="fade-up" data-aos-anchor-placement="top-center">
                     <div className="taskInnnerText">
                        <p>담당업무</p>
                     </div>
                     <ul>
                        <li>support 페이지</li>
